...
const {LoginSuperAdmin} = require ('../../projectobjects/LoginSuperAdmin');

test('Add New Profile', async ({ page }) => {

    const loginSuperAdmin = new LoginSuperAdmin(page);
    await loginSuperAdmin.goTo();
    await loginSuperAdmin.validLogin();
